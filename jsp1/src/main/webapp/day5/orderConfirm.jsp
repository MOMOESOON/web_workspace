...
<ul>
	...
	<li>고객 이메일 : <jsp:getProperty property="pcode" name="order"/><li>
	<li>고객 이메일 : <jsp:getProperty property="quantity" name="order"/><li>
...
%>
	<script type="text/javascript">alert('주문완료 되었습니다.')
	</script>
	<%
		}
	%>
