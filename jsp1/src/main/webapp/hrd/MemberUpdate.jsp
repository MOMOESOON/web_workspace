	...
	<section>
		...
		<table>
         <tr>
            ...
            <!-- MemberList.jsp 에서 보낸 파라미터를 받아 custno 변수에 저장합니다. 그리고 value에서 출력하기. -->
            <td><input type="text" id="Number" value="<%= custno %>" disabled="disabled" >
            <input type="hidden" name="custno" value="<%= custno %>">
            </td>
         </tr>
         <tr>
            <td><label for="Name">회원성명</label></td>
            <td><input type="text" id="Name"  name="custname" value="<%=dto.getCustname()%>">
            </td>
         </tr>
         <tr>
            <td><label for="Phone">회원전화</label></td>
            <td><input type="text" id="Phone" value="<%=dto.getPhone() %>" name="phone">
            </td>
         </tr>
         <tr>
            <td><label for="Adress">회원주소</label></td>
            <td><input type="text" id="Adress" value="<%=dto.getAddress() %>" name="address">
            </td>
         <tr>
            <td><label for="Date">가입일자</label></td>
            <td><input type="date" id="Date" value="<%=dto.getJoindate() %>" name="joindate">
            </td>
         <tr>
            <td><label for="Grade">고객등급[A:VIP,B:일반,C:직원]</label></td>
            <td><input type="text" id="Grade" value="<%=dto.getGrade() %>" name="grade">
            </td>
         <tr>
            <td><label for="Citycode">도시코드</label></td>
            <td><input type="text" id="Citycode" value="<%=dto.getCity()  %>" name="city">
            </td>
         </tr>
         <tr>
         	<td colspan="2">
