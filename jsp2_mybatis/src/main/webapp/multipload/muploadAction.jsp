...
<% 
   ...
   StringBuilder picture = new StringBuilder();
	...
	while(ens.hasMoreElements()){	//가져올 다음 요소가 있다면
		String input =(String)ens.nextElement();	//iterator 처럼 하나씩 가져오기. 리턴은 name 속성값
   ...
   ProductDto dto = new ProductDto(pname,Integer.parseInt(price),
		   null,picture.toString()); 
   //StringBuilder 를 String으로 변환
